...
// configs/hunian/apartemen/lingkungan.ts

const lingkungan = {
  id: "lingkungan",
  title: "Lingkungan",
  description: "Lokasi apartemen relatif terhadap fasilitas umum sekitar.",
  ...
  fields: [
    ...
    { id: "near_pharmacy", label: "Dekat Apotek", type: "checkbox", required: false },
    ...
    { id: "near_modern_market", label: "Dekat Pasar Modern", type: "checkbox", required: false },
    ...
    { id: "near_terminal", label: "Dekat Terminal", type: "checkbox", required: false },
    ...
    { id: "near_harbor", label: "Dekat Pelabuhan", type: "checkbox", required: false },
    { id: "near_mosque", label: "Dekat Masjid", type: "checkbox", required: false },
    { id: "near_church", label: "Dekat Gereja", type: "checkbox", required: false },
    { id: "near_temple", label: "Dekat Pura", type: "checkbox", required: false },
    { id: "near_vihara", label: "Dekat Vihara", type: "checkbox", required: false },
    { id: "near_city_park", label: "Dekat Taman Kota", type: "checkbox", required: false },
    { id: "near_playground", label: "Dekat Playground", type: "checkbox", required: false },
    { id: "near_sport_center", label: "Dekat Sport Center", type: "checkbox", required: false },
    { id: "near_golf_course", label: "Dekat Lapangan Golf", type: "checkbox", required: false },
    { id: "near_tourist_spot", label: "Dekat Tempat Wisata", type: "checkbox", required: false },
    ...
    { id: "wide_road_access", label: "Akses Jalan Lebar", type: "checkbox", required: false },
