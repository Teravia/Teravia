// configs/hunian/penthouse/fasilitas-unit.ts

const fasilitasUnit = {
  id: "fasilitas-unit",
  title: "Fasilitas Unit",
  description: "Fasilitas standar yang tersedia di dalam unit penthouse.",
  ...
  fields: [
    ...
    { id: "cooker_hood", label: "Cooker Hood", type: "checkbox", required: false },
    { id: "gas_stove", label: "Kompor Gas", type: "checkbox", required: false },
    { id: "oven", label: "Oven", type: "checkbox", required: false },
    { id: "microwave", label: "Microwave", type: "checkbox", required: false },
    ...
    { id: "dryer", label: "Dryer", type: "checkbox", required: false },
    { id: "water_heater", label: "Water Heater", type: "checkbox", required: false },
    { id: "bathtub", label: "Bathtub", type: "checkbox", required: false },
    { id: "smart_tv", label: "Smart TV", type: "checkbox", required: false },
    { id: "wifi", label: "WiFi", type: "checkbox", required: false },
    { id: "smart_home", label: "Smart Home", type: "checkbox", required: false },
    { id: "smart_door_lock", label: "Smart Door Lock", type: "checkbox", required: false },
    { id: "smart_curtain", label: "Smart Curtain", type: "checkbox", required: false },
    { id: "smart_lighting", label: "Smart Lighting", type: "checkbox", required: false },
  ],
};
