// configs/hunian/penthouse/biaya-rutin.ts

const biayaRutin = {
  id: "biaya-rutin",
  title: "Biaya Rutin",
  description: "Perkiraan biaya rutin bulanan/tahunan unit penthouse.",

  fields: [
    { id: "maintenance_fee", label: "Biaya IPL / Maintenance Bulanan", type: "currency", required: false },
    {
      id: "maintenance_fee_unit",
      label: "Satuan Biaya IPL",
      type: "select",
      required: false,
      options: ["per m2", "Flat per Unit"],
    },
    ...
    { id: "parking_fee", label: "Biaya Parkir Bulanan", type: "currency", required: false },
    { id: "pbb_annual", label: "PBB per Tahun", type: "currency", required: false },
    {
      ...
      type: "multiselect",
      required: false,
      options: ["Keamanan", "Kebersihan", "Concierge", "Parkir"],
    },
    {
      id: "other_fees",
      label: "Biaya Lainnya",
