// configs/hunian/villa/validator.ts
//
// Helper untuk memvalidasi field wajib (required) pada section
// spesifikasi villa. Key error mengikuti konvensi fieldKey yang
// dipakai di Step1Information.tsx: `s{sectionIdx}_f{fieldIdx}`.

import villa from "./index";

export function validateVillaDetail(
  detailData: Record<string, any>
): Record<string, string> {
  const errors: Record<string, string> = {};

  villa.forEach((section: any, sectionIdx: number) => {
...
export default validateVillaDetail;
