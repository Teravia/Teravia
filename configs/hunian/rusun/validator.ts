// configs/hunian/rusun/validator.ts
//
// Helper untuk memvalidasi field wajib (required) pada section
// spesifikasi rusun. Key error mengikuti konvensi fieldKey yang
// dipakai di Step1Information.tsx: `s{sectionIdx}_f{fieldIdx}`.

import rusun from "./index";

export function validateRusunDetail(
  detailData: Record<string, any>
): Record<string, string> {
  const errors: Record<string, string> = {};

  rusun.forEach((section: any, sectionIdx: number) => {
...
export default validateRusunDetail;
