// configs/hunian/kost/informasi-tambahan.ts

const informasiTambahan = {
  id: "informasi-tambahan",
  title: "Informasi Tambahan",
  description: "Informasi pendukung mengenai kost.",
  ...
  fields: [
    {
      ...
      rows: 5,
      maxLength: 3000,
      placeholder: "Jelaskan keunggulan utama kost...",
    },
    {
      id: "negotiable",
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      placeholder: "Kost Putri, Dekat Kampus, AC, dll",
    },
    {
      id: "seo_keywords",
      label: "Keyword SEO",
      type: "tags",
      required: false,
      placeholder: "Kost Putri Jakarta, Kost Bulanan Dekat Kampus, dll",
    },
    {
