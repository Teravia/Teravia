// configs/hunian/cluster/fasilitas-rumah.ts

const fasilitasRumah = {
  id: "fasilitas-rumah",
  title: "Fasilitas Rumah",
  description: "Fasilitas yang tersedia di dalam unit rumah.",
  ...
  fields: [
    ...
    { id: "exhaust_fan", label: "Exhaust Fan", type: "checkbox", required: false },
    ...
    { id: "electric_stove", label: "Kompor Listrik", type: "checkbox", required: false },
    ...
    { id: "freezer", label: "Freezer", type: "checkbox", required: false },
    { id: "dishwasher", label: "Dishwasher", type: "checkbox", required: false },
    ...
    { id: "jacuzzi", label: "Jacuzzi", type: "checkbox", required: false },
    ...
    { id: "fiber_internet", label: "Internet Fiber Optic", type: "checkbox", required: false },
    { id: "tv_cable", label: "TV Kabel", type: "checkbox", required: false },
    ...
    { id: "garden", label: "Taman", type: "checkbox", required: false },
    { id: "gazebo", label: "Gazebo", type: "checkbox", required: false },
    { id: "fish_pond", label: "Kolam Ikan", type: "checkbox", required: false },
    ...
    { id: "playground", label: "Playground", type: "checkbox", required: false },
