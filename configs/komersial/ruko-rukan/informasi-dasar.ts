// configs/komersial/ruko-rukan/informasi-dasar.ts

const informasiDasar = {
  id: "informasi-dasar",
  title: "Informasi Dasar",
  description: "Informasi umum mengenai listing ruko/rukan.",
  ...
  fields: [
...

    {
      ...
      required: true,
      options: [
        "Ruko (Usaha Dagang / Retail)",
        "Rukan (Kantor)",
        "Campuran (Dagang & Kantor)",
      ],
    },
...

    {
      ...
      rows: 8,
      maxLength: 5000,
      placeholder: "Jelaskan keunggulan ruko/rukan secara lengkap...",
    },
