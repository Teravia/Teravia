// configs/tanah/kavling/informasi-dasar.ts

const informasiDasar = {
  id: "informasi-dasar",
  title: "Informasi Dasar",
  description: "Informasi umum mengenai listing tanah kavling.",
  ...
  fields: [
...

    {
      ...
      options: [
        "Kosong / Siap Bangun",
        "Ada Bangunan Lama (Akan Dibongkar)",
        "Dalam Proses Cut & Fill",
      ],
    },
...

    {
      ...
      rows: 8,
      maxLength: 5000,
      placeholder: "Jelaskan keunggulan tanah kavling secara lengkap...",
    },
