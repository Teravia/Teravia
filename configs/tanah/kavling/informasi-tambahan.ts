// configs/tanah/kavling/informasi-tambahan.ts

const informasiTambahan = {
  id: "informasi-tambahan",
  title: "Informasi Tambahan",
  description: "Informasi pendukung mengenai tanah kavling.",
  ...
  fields: [
    {
      ...
      rows: 5,
      maxLength: 3000,
      placeholder: "Jelaskan keunggulan utama tanah kavling...",
    },
    {
      id: "selling_reason",
      label: "Alasan Dijual",
    ...
    },
    {
      ...
      label: "Bisa Dijual Sebagian (Kaveling)",
      type: "radio",
      required: false,
      options: ["Ya", "Tidak"],
    },
    ...
    },
    {
      ...
      type: "tags",
      required: false,
      placeholder: "Kavling Siap Bangun, SHM, dll",
    },
    {
      id: "seo_keywords",
      label: "Keyword SEO",
      type: "tags",
      required: false,
      placeholder: "Tanah Kavling Dijual Bogor, Kavling SHM, dll",
    },
    {
