// configs/tanah/kebun/legalitas.ts

const legalitas = {
  id: "legalitas",
  title: "Legalitas",
  description: "Informasi legalitas dan status kepemilikan tanah kebun.",
  ...
  fields: [
    ...
    { id: "certificate_holder_name", label: "Atas Nama Sertifikat", type: "text", required: false, placeholder: "Masukkan Atas Nama Sertifikat" },
    {
      ...
      type: "select",
      required: false,
      options: ["Kawasan Perkebunan", "Hutan Produksi Konversi", "Bisa Alih Fungsi", "Belum Diketahui"],
    },
    {
